...
---------------------------------------------------------------------------------------*/
    ...
    function showModal(modal,message,menu)
    {
		...
		if (modal == "confirmShare") {
			...
			{
				openWindow(lookupShareURL(),640,480,"inapp");
				hideModal();
				return false;
			});
...
---------------------------------------------------------------------------------------*/
	...
	function openWindow(windowURL,windowWidth,windowHeight,windowTarget) {
...
---------------------------------------------------------------------------------------*/
	...
	function initNav(){
		...
		$('.socialControls').on('click',function(){
			...
			*/
				openWindow("http://twitter.com/SayingOfTheWise",640,480,"inbrowser");
...
var msgAppInfo ="<div class='Info'><h2 class='unicode'>✝</h2><p><span>Returning with increase</span> to the Lord.</p><p>&copy; 2014 Douglas Scamahorn</p><p><a href='privacy.html' onclick='showPrivacyScreen(); return false;'>Privacy Policy</a></p><p><a href='https://github.com/dscamahorn/SayingsOfTheWise-App-Mobile' onclick='openWindow(\"https://github.com/dscamahorn/SayingsOfTheWise-App-Mobile\",640,480,\"inbrowser\"); return false;'>Source &#60;Code&#47;&#62;</a></p><p><a href='https://twitter.com/SayingOfTheWise' onclick='openWindow(\"https://twitter.com/SayingOfTheWise\",640,480,\"inbrowser\"); return false;'>&#64;SayingOfTheWise</a></p></div>";
